...
namespace ET
{
    public static class AssetsBundleHelper
    {
        ...
        {
            return LoadBundle(assetBundleName, out UnityEngine.AssetBundle assetBundle);
        }

        public static Dictionary<string, UnityEngine.Object> LoadBundle(string assetBundleName, out UnityEngine.AssetBundle assetBundle)
        {

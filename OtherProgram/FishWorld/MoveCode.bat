...
set GitHubMonoBattlePath=%GitHubProjectPath%\%MonoPath%\%BattleCodePath%
...
xcopy %SVNProjectPath%\%MonoPath%\%BattleCodePath% %GitHubMonoBattlePath% /E /F /I
